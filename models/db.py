...
auth.messages.verify_email = 'Click on the link http://' + \
    request.env.http_host + URL(r=request,
                                c='default',
                                f='user',
                                args=['verify_email']) + \
...
db.define_table('templates',
            Field('name', 'string',
                        ...
                        requires=[IS_NOT_EMPTY(),
                                  IS_NOT_IN_DB(db, 'templates.name')],
                        ),
            Field('dgroup', 'string',
...
db.define_table('config',
            ...
            Field('ocr', 'string',
                        ...
                        default='/usr/local/bin/tesseract $filefrom ' + \
                                '$fileto -lang $lang' ,
                        comment=T('subs.: $filefrom - the file to' + \
                                  ' recognize, $fileto - the text ' + \
                                  'file, $lang - how to put the ' + \
                                  'selected language')),
